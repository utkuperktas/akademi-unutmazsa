---
title: "Basılmayan Bir Kitabın Notu"
---

Nedenini tam olarak bilmiyorum.

Çünkü ben bu kitabın basılmasını istedim. Sorun neydi, onu bilmiyorum.

Dosyayı birkaç yayınevine gönderdim. Aldığım yanıtlardan biri şöyleydi:
...
Bir başka Guardian yazısında Hamilton Nolan ^[Hamilton Nolan, *Envy, Ego, Pride and Pain: What I Learned from Publishing My First Book*, The Guardian, 2024.] kitabın değerinin satış rakamlarıyla ölçülemeyeceğini hatırlatıyordu. Ona göre insanlar bir kitabı zengin olmak ya da ünlü olmak için yazmaz. Bir kitap yazmanın asıl nedeni, söylenmek istenen bir şeyin zaman içinde kaybolmamasıdır.

Yazıların çoğunun zamanla unutulduğu doğrudur.

Ama bir kitap bir kütüphanenin rafında kalabilir ve yıllar sonra hiç tanımadığınız birinin eline geçebilir.
...
Belki de bazı kitaplar yayınevlerinin raflarından çok, okurun kendi keşfine bırakıldığında gerçek anlamını bulur.

Bazı kitaplar yayınevlerinde doğmaz; okurun bulması için dünyaya bırakılır.